      ...
      >
        ...
        <div className="p-8 border-b border-gray-50 flex items-center justify-between bg-gray-50/50">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="text-xl font-black text-gray-900">Car Loan Wizard</h3>
          ...
          <AnimatePresence mode="wait">
            {step === 1 && (
              ...
              >
                ...
                <div className="space-y-4">
                  <div>
                    <label className="text-xs font-black text-gray-400 uppercase mb-2 block">Loan Name</label>
                    <input
                      type="text"
            ...
            {step === 2 && (
              ...
              >
                ...
                <div className="space-y-4">
                  <div>
                    <label className="text-xs font-black text-gray-400 uppercase mb-2 block">Repayment Amount</label>
                    <div className="relative">
                      <span className="absolute left-5 top-1/2 -translate-y-1/2 font-bold text-gray-400">$</span>
                      <input
                        type="number"
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="text-xs font-black text-gray-400 uppercase mb-2 block">Frequency</label>
                      <select
                    ...
                    <div>
                      <label className="text-xs font-black text-gray-400 uppercase mb-2 block">Source Account</label>
                      <select
                  ...
                  <div>
                    <label className="text-xs font-black text-gray-400 uppercase mb-2 block">Next Payment Date</label>
                    <input
                      type="date"
            ...
            {step === 3 && (
              ...
              >
                ...
                <div>
                  <h3 className="text-2xl font-black text-gray-900">Confirm Car Loan</h3>
                ...
                <div className="bg-gray-50 p-6 rounded-3xl text-left space-y-3">
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-400 font-bold">Loan Balance</span>
                    <span className="text-gray-900 font-black">${parseFloat(formData.totalBalance).toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-400 font-bold">Repayment</span>
