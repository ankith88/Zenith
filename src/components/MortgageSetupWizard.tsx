      ...
      >
        ...
        <div className="p-8 border-b border-gray-50 dark:border-gray-800 flex items-center justify-between bg-gray-50/50 dark:bg-gray-800/50 transition-colors">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="text-xl font-black text-gray-900 dark:text-white transition-colors">Mortgage Wizard</h3>
          ...
          <AnimatePresence mode="wait">
            {step === 1 && (
              <motion.div
                ...
                className="space-y-6"
              >
                <div className="bg-indigo-50 dark:bg-indigo-900/20 p-4 rounded-2xl flex gap-3 items-start transition-colors">
                ...
                <div className="space-y-4">
                  <div>
                    <label className="text-xs font-black text-gray-400 dark:text-gray-500 uppercase mb-2 block transition-colors">Mortgage Name</label>
                    <input
                      type="text"
            ...
            {step === 2 && (
              ...
              >
                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="text-xs font-black text-gray-400 dark:text-gray-500 uppercase mb-2 block tracking-wider transition-colors">Frequency</label>
                      <select
                    ...
                    <div>
                      <label className="text-xs font-black text-gray-400 dark:text-gray-500 uppercase mb-2 block tracking-wider transition-colors">Due Day</label>
                      <input
                        type="number"
                        min="1"
                  ...
                  {/* Business Share */}
                  <div className="p-5 bg-gray-50 dark:bg-gray-800 rounded-3xl space-y-4 transition-colors">
                    <div className="flex items-center gap-3">
                      <Briefcase className="w-5 h-5 text-gray-400 dark:text-gray-500 transition-colors" />
                      <h4 className="text-sm font-black text-gray-900 dark:text-white uppercase transition-colors">Business Contribution</h4>
                    </div>
                    <div className="grid grid-cols-2 gap-3">
                      <select
                        value={formData.businessAccountId}
                        onChange={(e) => setFormData({ ...formData, businessAccountId: parseInt(e.target.value) })}
                        className="px-4 py-3 bg-white dark:bg-gray-900 border-none rounded-xl text-sm font-bold outline-none text-gray-900 dark:text-white transition-colors"
                      >
                      ...
                      <input
                        ...
                        placeholder="Amount"
                        className="px-4 py-3 bg-white dark:bg-gray-900 border-none rounded-xl text-sm font-bold outline-none text-gray-900 dark:text-white transition-colors placeholder:text-gray-300 dark:placeholder:text-gray-600"
                      />
                    </div>
                  </div>
                  ...
                  <div className="p-5 bg-gray-50 dark:bg-gray-800 rounded-3xl space-y-4 transition-colors">
                    <div className="flex items-center gap-3">
                      ...
                      <h4 className="text-sm font-black text-gray-900 dark:text-white uppercase transition-colors">Your Contribution</h4>
                    </div>
                    <div className="grid grid-cols-2 gap-3">
                      <select
                  ...
                  <div className="p-5 bg-gray-50 dark:bg-gray-800 rounded-3xl space-y-4 transition-colors">
                    <div className="flex items-center gap-3">
                      <Users className="w-5 h-5 text-gray-400 dark:text-gray-500 transition-colors" />
                      <h4 className="text-sm font-black text-gray-900 dark:text-white uppercase transition-colors">Wife's Contribution</h4>
                    </div>
                    <div className="grid grid-cols-2 gap-3">
                      <select
            ...
            {step === 3 && (
              ...
              >
                ...
                <div>
                  <h3 className="text-2xl font-black text-gray-900 dark:text-white transition-colors">Ready to Launch?</h3>
                ...
                <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-3xl text-left space-y-3 transition-colors">
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-400 dark:text-gray-500 font-bold transition-colors">Mortgage Balance</span>
                  ...
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-400 dark:text-gray-500 font-bold transition-colors">Total Monthly Split</span>
